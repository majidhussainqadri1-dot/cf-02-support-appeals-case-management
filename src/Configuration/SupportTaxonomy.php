...
final class SupportTaxonomy
{
    ...
    {
        $categories = [
            new SupportCategory('account_access', 'Account and Access', 'account', ['account_support', 'privacy_safe_handling'], 'C3', 'Files 00/02', ['issue_type', 'account_reference', 'contact_method']),
            new SupportCategory('verification', 'Verification', 'verification', ['verification_support', 'privacy_safe_handling'], 'C3', 'File 09', ['verification_reference', 'issue_type', 'requested_outcome']),
            ...
            new SupportCategory('learning_access', 'Learning Access', 'learning', ['learning_support'], 'C2', 'File 05 / File 00 access assertions', ['learning_reference', 'access_issue', 'issue_type']),
            ...
            new SupportCategory('privacy_data_rights', 'Privacy and Data Rights', 'privacy_liaison', ['privacy_liaison', 'restricted_evidence'], 'C4', 'File 24 / native privacy owner', ['request_type', 'identity_verification_reference', 'scope'], true),
            new SupportCategory('safety_abuse', 'Safety and Abuse', 'safety_liaison', ['safety_liaison', 'restricted_evidence'], 'C4', 'Relevant native safety owner', ['report_type', 'subject_reference', 'immediacy'], true),
            new SupportCategory('institutional_governance', 'Institutional Governance and Due Process', 'governance_liaison', ['institutional_governance', 'due_process_review', 'restricted_evidence'], 'C4', 'Founder / File 24 / native institutional owner', ['policy_reference', 'notice_reference', 'matter_classification'], true),
