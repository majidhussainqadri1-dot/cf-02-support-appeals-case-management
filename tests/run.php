...
$identity=['runtime_version'=>'1.0.0-rc.4','schema_version'=>'1.3.0','source_sha'=>str_repeat('a',40),'package_sha256'=>str_repeat('b',64)];
...
$test('taxonomy and purpose-separated queues validate',static function():void{$t=SupportTaxonomy::defaults();assert(count($t)===12);assert(SupportTaxonomy::validate()===[]);assert(QueueRegistry::validate()===[]);assert(count(QueueRegistry::defaults())===11);});
