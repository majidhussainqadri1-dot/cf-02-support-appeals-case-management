...
|---|---|---:|---|---|
| `account_access` | `identity` | C3 | Files 00/02 | No |
| `verification` | `identity` | C3 | File 09 | No |
...
| `privacy_data_rights` | `sensitive_liaison` | C4 | File 24 / native privacy owner | Yes |
| `safety_abuse` | `sensitive_liaison` | C4 | Relevant native safety owner | Yes |
...
Sensitive liaison work is not an ordinary general-support queue. It requires purpose-bound assignment and approved specialist access.
